...
void main(){
	FILE* NoisySinWave; //this is my input file
	...
	if(NoisySinWave != NULL){ //this is reading all the lines in the file to determine the size
		while(fscanf(NoisySinWave,"%f %f",&temp_x,&temp_y)!= EOF){
			counter++;
		}
